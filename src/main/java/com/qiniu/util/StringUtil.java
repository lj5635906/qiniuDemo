...
public class StringUtil extends StringUtils {
	...
	public static String fixPathStartWithSlash(String path) {
		...
		if (isNotEmpty(fixedPath)) {
			fixedPath = fixedPath.replaceAll("\\\\+", "/");
			fixedPath = fixedPath.replaceAll("/+", "/");
			fixedPath = startsWith(fixedPath, "/") ? fixedPath
					: ("/" + fixedPath);
		}
		return fixedPath;
	}
	...
	public static String fixPathRemoveFirstSlash(String path) {
		...
		if (isNotEmpty(fixedPath)) {
			fixedPath = fixedPath.replaceAll("\\\\+", "/");
			fixedPath = fixedPath.replaceAll("/+", "/");
			fixedPath = startsWith(fixedPath, "/") ? substringAfter(fixedPath,
					"/") : fixedPath;
		}
		return fixedPath;
	}
	...
	public static String fixPathEndWithSlash(String path) {
		...
		if (isNotEmpty(fixedPath)) {
			fixedPath = fixedPath.replaceAll("\\\\+", "/");
			fixedPath = fixedPath.replaceAll("/+", "/");
			fixedPath = endsWith(fixedPath, "/") ? fixedPath
					: (fixedPath + "/");
		}
		return fixedPath;
	}
	...
	public static String fixPathRemoveLastSlash(String path) {
		...
		if (isNotEmpty(fixedPath)) {
			fixedPath = fixedPath.replaceAll("\\\\+", "/");
			fixedPath = fixedPath.replaceAll("/+", "/");
			fixedPath = endsWith(fixedPath, "/") ? substringBeforeLast(
					fixedPath, "/") : fixedPath;
		}
		return fixedPath;
	}
