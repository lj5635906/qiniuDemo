...
public class DateUtil implements ConstantDate {
	...
	public static final SimpleDateFormat DATE_FORMAT_YYYY = new SimpleDateFormat(
			"yyyy");
	/** yyyyMM */
	public static final SimpleDateFormat DATE_FORMAT_YYYY_MM = new SimpleDateFormat(
			"yyyyMM");
	/** yyyyMMdd */
	public static final SimpleDateFormat DATE_FORMAT_YYYY_MM_DD = new SimpleDateFormat(
			"yyyyMMdd");
	/** yyyyMMddHH */
	public static final SimpleDateFormat DATE_FORMAT_YYYY_MM_DD_HH = new SimpleDateFormat(
			"yyyyMMddHH");
	/** yyyyMMddHHmm */
	...
	public static final SimpleDateFormat DATE_FORMAT_DASH_YYYY_MM = new SimpleDateFormat(
			"yyyy-MM");
	/** yyyy-MM-dd */
	public static final SimpleDateFormat DATE_FORMAT_DASH_YYYY_MM_DD = new SimpleDateFormat(
			"yyyy-MM-dd");
	/** yyyy-MM-dd HH */
	public static final SimpleDateFormat DATE_FORMAT_DASH_YYYY_MM_DD_HH = new SimpleDateFormat(
			"yyyy-MM-dd HH");
	/** yyyy-MM-dd HH:mm */
	...
	public static final SimpleDateFormat DATE_FORMAT_SLASH_YYYY_MM_DD = new SimpleDateFormat(
			"yyyy/MM/dd");
	/** yyyy/MM/dd HH */
	public static final SimpleDateFormat DATE_FORMAT_SLASH_YYYY_MM_DD_HH = new SimpleDateFormat(
			"yyyy/MM/dd HH");
	/** yyyy/MM/dd HH:mm */
	...
	public static final SimpleDateFormat DATE_FORMAT_CHINESE_YYYY_MM_DD = new SimpleDateFormat(
			"yyyy年MM月dd日");
	/** yyyy年MM月dd日 HH时 */
	public static final SimpleDateFormat DATE_FORMAT_CHINESE_YYYY_MM_DD_HH = new SimpleDateFormat(
			"yyyy年MM月dd日 HH时");
	/** yyyy年MM月dd日 HH时mm分 */
	public static final SimpleDateFormat DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM = new SimpleDateFormat(
			"yyyy年MM月dd日 HH时mm分");
	/** yyyy年MM月dd日 HH时mm分ss秒 */
	public static final SimpleDateFormat DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS = new SimpleDateFormat(
			"yyyy年MM月dd日 HH时mm分ss秒");
	/** yyyy年MM月dd日 HH时mm分ss秒SSS毫秒 */
	public static final SimpleDateFormat DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS_SSS = new SimpleDateFormat(
			"yyyy年MM月dd日 HH时mm分ss秒SSS毫秒");
	...
	public static synchronized String dateFormat(String date,
			SimpleDateFormat inPattern, SimpleDateFormat outPattern) {
	 ...
	 * @return Calendar
	 */
	public static synchronized Calendar parseCalendarHourDashFormat(
			String strDate) {
		String pattern = DATE_FORMAT_DASH_YYYY_MM_DD_HH.toPattern();
		return parseCalendarFormat(strDate, pattern);
	}
	 ...
	 * @return Calendar
	 */
	public static synchronized Calendar parseCalendarHourSlashFormat(
			String strDate) {
		String pattern = DATE_FORMAT_SLASH_YYYY_MM_DD_HH.toPattern();
		return parseCalendarFormat(strDate, pattern);
	}
	 ...
	 * @return Calendar
	 */
	public static synchronized Calendar parseCalendarHourChineseFormat(
			String strDate) {
		String pattern = DATE_FORMAT_CHINESE_YYYY_MM_DD_HH.toPattern();
		return parseCalendarFormat(strDate, pattern);
	}
	 ...
	 * @return Calendar
	 */
	public static synchronized Calendar parseCalendarSecondChineseFormat(
			String strDate) {
		String pattern = DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS.toPattern();
		return parseCalendarFormat(strDate, pattern);
	}
	...
	public static synchronized String getDateMilliChineseFormat(Calendar cal) {
		String pattern = DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS_SSS
				.toPattern();
		return getDateFormat(cal, pattern);
	}
	 ...
	 * @return Calendar
	 */
	public static synchronized Calendar parseCalendarMilliChineseFormat(
			String strDate) {
		String pattern = DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS_SSS
				.toPattern();
		return parseCalendarFormat(strDate, pattern);
	 ...
	 * @return
	 */
	public static synchronized List<Date> getAllDayOfMonthByWeek(Date date,
			int week) {
	 ...
	 * @return
	 */
	public static synchronized List<String> getAllDayOfMonthByWeek(Date date,
			int week, SimpleDateFormat pattern) {
	 ...
	 * @return
	 */
	public static synchronized List<String> getAfterTodayOfMonthByWeek(
			int week, SimpleDateFormat pattern) {
		List<String> list = new ArrayList<String>();
		// 取得当前日期
		GregorianCalendar firstGc = (GregorianCalendar) Calendar.getInstance();
	 ...
	 */
	public static synchronized List<String> getAfterTodayOfMonthByWeek(
			String week, SimpleDateFormat pattern) {
		List<String> list = new ArrayList<String>();
		// 取得当前日期
		GregorianCalendar firstGc = (GregorianCalendar) Calendar.getInstance();
		firstGc.setTime(new Date());
	...
	public static String getAddNSeason(String inSeason, int n) {
		...
		if (inSeason != null && inSeason.length() == 5) {
			...
			outSeason = StringUtils.leftPad(String.valueOf(year), 4, "0")
	...
	public static String formatYearAndSeason(String inSeason, String patten) {
		...
		if (inSeason != null && inSeason.length() == 5
				&& (StringUtils.countMatches(patten, "yyyy") == 1)
				&& (StringUtils.countMatches(patten, "s") == 1)) {
			outSeason = StringUtils.replace(patten, "yyyy",
					inSeason.substring(0, 4));
			outSeason = StringUtils.replace(outSeason, "s",
					inSeason.substring(4, 5));
		}
		return outSeason;
	}
	 ...
	 * @return
	 */
	public static synchronized int getYears(String strStartDate,
			String strEndDate) {
		int startYear = 0;
		int endYear = 0;
		if (StringUtils.length(strStartDate) < 4
				|| StringUtils.length(strEndDate) < 4) {
			return 0;
		}
	 ...
	 * @return
	 */
	public static synchronized int getMonths(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (StringUtils.isEmpty(strStartDate)
				|| StringUtils.isEmpty(strEndDate)
				|| strStartDate.length() != strEndDate.length()) {
			return 0;
		}

		if (DateUtil.DATE_FORMAT_YYYY_MM.toPattern()
				.equals(pattern.toPattern())) {
			// yyyyMM
		...
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM.toPattern().equals(
				pattern.toPattern())) {
			// yyyy-MM
			...
			endYear = calendar.get(Calendar.YEAR);
			endMonth = calendar.get(Calendar.MONTH) + 1;
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM.toPattern().equals(
				pattern.toPattern())) {
			// yyyy/MM
			...
			endYear = calendar.get(Calendar.YEAR);
			endMonth = calendar.get(Calendar.MONTH) + 1;
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM.toPattern().equals(
				pattern.toPattern())) {
			// yyyy年MM月
		...
		int difMonth = (endYear - startYear - 1) * 12 + (12 - startMonth)
				+ endMonth;
	 ...
	 * @return
	 */
	public static synchronized int getDays(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (DateUtil.DATE_FORMAT_YYYY_MM_DD.toPattern().equals(
				pattern.toPattern())) {
			// yyyyMMdd
		...
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM_DD.toPattern().equals(
				pattern.toPattern())) {
			// yyyy-MM-dd
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM_DD.toPattern().equals(
				pattern.toPattern())) {
			// yyyy/MM/dd
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM_DD.toPattern().equals(
				pattern.toPattern())) {
			// yyyy年MM月dd日
	 ...
	 * @return
	 */
	public static synchronized int getHours(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (DateUtil.DATE_FORMAT_YYYY_MM_DD_HH.toPattern().equals(
				pattern.toPattern())) {
			// yyyyMMddHH
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM_DD_HH.toPattern().equals(
				pattern.toPattern())) {
			// yyyy-MM-dd HH
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM_DD_HH.toPattern().equals(
				pattern.toPattern())) {
			// yyyy/MM/dd HH
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM_DD_HH.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy年MM月dd日 HH时
	 ...
	 * @return
	 */
	public static synchronized int getMinutes(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (DateUtil.DATE_FORMAT_YYYY_MM_DD_HH_MM.toPattern().equals(
				pattern.toPattern())) {
			// yyyyMMddHHmm
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM_DD_HH_MM.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy-MM-dd HH:mm
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM_DD_HH_MM.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy/MM/dd HH:mm
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy年MM月dd日 HH时mm分
	 ...
	 * @return
	 */
	public static synchronized int getSeconds(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (DateUtil.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS.toPattern().equals(
				pattern.toPattern())) {
			// yyyyMMddHHmmss
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM_DD_HH_MM_SS.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy-MM-dd HH:mm:ss
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM_DD_HH_MM_SS.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy/MM/dd HH:mm:ss
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS.toPattern()
				.equals(pattern.toPattern())) {
			// yyyy年MM月dd日 HH时mm分ss秒
	 ...
	 * @return
	 */
	public static synchronized long getMillis(String strStartDate,
			String strEndDate, SimpleDateFormat pattern) {
		...
		if (DateUtil.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS_SSS.toPattern().equals(
				pattern.toPattern())) {
			// yyyyMMddHHmmssSSS
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_DASH_YYYY_MM_DD_HH_MM_SS_SSS
				.toPattern().equals(pattern.toPattern())) {
			// yyyy-MM-dd HH:mm:ss,SSS
			calendar = parseCalendarMilliDashFormat(strStartDate);
			startMillis = calendar.getTimeInMillis();
			calendar = parseCalendarMilliDashFormat(strEndDate);
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_SLASH_YYYY_MM_DD_HH_MM_SS_SSS
				.toPattern().equals(pattern.toPattern())) {
			// yyyy/MM/dd HH:mm:ss,SSS
			...
			endMillis = calendar.getTimeInMillis();
		} else if (DateUtil.DATE_FORMAT_CHINESE_YYYY_MM_DD_HH_MM_SS_SSS
				.toPattern().equals(pattern.toPattern())) {
			// yyyy年MM月dd日 HH时mm分ss秒SSS毫秒
	...
	public static int getSeasons(String strStartSeason, String strEndSeason) {
		...
		if (StringUtils.isEmpty(strStartSeason)
				|| StringUtils.isEmpty(strEndSeason)
				|| strStartSeason.length() != 5 || strEndSeason.length() != 5) {
			return 0;
		}

		int startYear = Integer.parseInt(StringUtils.substring(strStartSeason,
				0, 4));
		int startSeason = Integer.parseInt(StringUtils.substring(
				strStartSeason, 4, 6));
		int endYear = Integer.parseInt(StringUtils
				.substring(strEndSeason, 0, 4));
		int endSeason = Integer.parseInt(StringUtils.substring(strEndSeason, 4,
				6));

		difSeason = (endYear - startYear - 1) * 4 + (4 - startSeason)
				+ endSeason;
	...
	public static void main(String[] agrs) {
		...
		System.out.println((DateUtil.getAllDayOfMonthByWeek(
				DateUtil.parseDateMonthFormat("201106"), 0)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(4)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(1,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(2,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(3,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(4,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(5,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(6,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek(7,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		System.out.println((DateUtil.getAfterTodayOfMonthByWeek("01",
				DATE_FORMAT_DASH_YYYY_MM_DD)));

		System.out.println(DateUtil.getDateSecondDashFormat(DateUtil
				.getAddNHour(new Date(), 3)));
		System.out.println(DateUtil.getDateSecondDashFormat(DateUtil
				.getAddNMinute(new Date(), 3)));
		System.out.println(DateUtil.getDateSecondDashFormat(DateUtil
				.getAddNSecond(new Date(), 3)));

		System.out.println(DateUtil.getYears("201001", "201111"));
		System.out.println(DateUtil.getMonths("201001", "200911",
				DATE_FORMAT_YYYY_MM));
		System.out.println(DateUtil.getDays("20110715", "20110710",
				DATE_FORMAT_YYYY_MM_DD));
		System.out.println(DateUtil.getHours("2011071511", "2011071515",
				DATE_FORMAT_YYYY_MM_DD_HH));
		System.out.println(DateUtil.getSeasons("20101", "20092"));

		System.out.println((DateUtil.getAllDayOfMonthByWeek(
				DateUtil.parseDateMonthFormat("201109"), 3,
				DATE_FORMAT_DASH_YYYY_MM_DD)));
		...
		System.out
				.println("20120318:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120318")));
		System.out
				.println("20120319:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120319")));
		System.out
				.println("20120320:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120320")));
		System.out
				.println("20120321:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120321")));
		System.out
				.println("20120322:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120322")));
		System.out
				.println("20120323:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120323")));
		System.out
				.println("20120324:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120324")));
		System.out
				.println("20120325:"
						+ DateUtil.getWeekOfDay(DateUtil
								.parseDateDayFormat("20120325")));
		System.out.println("==");
		System.out
				.println("20120318:"
						+ DateUtil.getDayOfWeek(DateUtil
								.parseDateDayFormat("20120318")));
		System.out
				.println("20120319:"
						+ DateUtil.getDayOfWeek(DateUtil
		...
		System.out
				.println("20120325:"
						+ DateUtil.getDayOfWeek(DateUtil
								.parseDateDayFormat("20120325")));
		System.out.println("==");
		System.out.println("20120301:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120301")));
		System.out.println("20120302:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120302")));
		System.out.println("20120303:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120303")));
		System.out.println("20120304:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120304")));
		System.out.println("20120323:" + DateUtil.getWeekOfMonth());
		System.out.println("20120325:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120325")));
		System.out.println("20120331:"
				+ DateUtil.getWeekOfMonth(DateUtil
						.parseDateDayFormat("20120331")));
		System.out.println("==");
		System.out.println("==");
		System.out.println("20120323:" + DateUtil.getDayOfMonth());
		System.out.println("20120101:"
				+ DateUtil.getDayOfMonth(DateUtil
						.parseDateDayFormat("20120101")));
		System.out.println("20120301:"
				+ DateUtil.getDayOfMonth(DateUtil
						.parseDateDayFormat("20120301")));
		System.out.println("==");
		...
		System.out
				.println("20120101:"
						+ DateUtil.getDayOfYear(DateUtil
								.parseDateDayFormat("20120101")));
		System.out
				.println("20120301:"
						+ DateUtil.getDayOfYear(DateUtil
								.parseDateDayFormat("20120301")));
		System.out.println("==");
		System.out.println(DateUtil.getDateDayDashFormat(DateUtil
				.getLastDayOfNextWeek(new Date())));
		System.out.println(DateUtil.getDateDayDashFormat(DateUtil
				.getLastDayOfNextWeek2(new Date())));
	}
}
